...
# Canonical city -> substrings that appear in Hirist location labels
...
# Hirist location ids used in /job/category/ loc= (target cities only)
HIRIST_LOC_IDS: dict[str, int] = {
    "Bengaluru": 3,
    "Chennai": 6,
    "Hyderabad": 4,
    "Coimbatore": 84,
...
def group_by_experience_city_company(
    ...
    *,
    ...
    """Group as experience range -> city -> company -> jobs[]."""
