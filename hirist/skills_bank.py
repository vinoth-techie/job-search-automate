"""Persistent skills bank with per-skill job referral counts (Hirist)."""
...
DEFAULT_SKILLS_FILE = str(portal_output_dir("hirist") / "skills.json")
...
def collect_skill_counts(jobs: Iterable[dict[str, Any]]) -> dict[str, int]:
    ...
    # Highest referral count first, then name.
    ordered = sorted(
        counts.keys(),
