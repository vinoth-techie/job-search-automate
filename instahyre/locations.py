...
# Canonical city -> substrings that appear in Instahyre location labels
...
def group_by_experience_city_company(
    ...
    *,
    ...
    """Group as experience (years) -> city -> company -> jobs[]."""
    keys = experience_keys or sorted(
        jobs_by_experience.keys(),
